    ...
    return (
        <article className="about" id="about" >
            <div className="aboutInfo" data-aos="fade-right">
                ...
                <p>Hello! My name is <span style={{color:"var(--green)"}}>Harshit</span> and I enjoy creating things that live on the internet. My interest in web development started back in jan 2021 when I decided to try editing custom Tumblr themes — turns out hacking together a custom reblog button taught me a lot about HTML & CSS!</p>
